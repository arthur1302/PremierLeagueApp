...
interface SoccerRepository {
    ...
    suspend fun getMatcesByTeam(teamId: Int, apiKey: String): List<Match>?
}
...
class ApiSoccerRepository(
    ...
    override suspend fun getTeams(apiKey: String): List<Team>? {
        val result: Response<TeamApiResponse> = teamApiService.getTeams("e2b1a771617b483bb629ab23272611a3")
    ...
    override suspend fun getSingleTeam(teamId: Int, apiKey: String): Team? {
        val result: Response<Team> = teamApiService.getSingleTeam(teamId, "e2b1a771617b483bb629ab23272611a3")
        val team: Team? = result?.body()
        return team
    }

    override suspend fun getMatcesByTeam(teamId: Int, apiKey: String): List<Match>? {
